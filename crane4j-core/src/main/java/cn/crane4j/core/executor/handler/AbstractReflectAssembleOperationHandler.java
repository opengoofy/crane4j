 ...
 * @param <T> target type
 */
public abstract class AbstractReflectAssembleOperationHandler<T extends AbstractReflectAssembleOperationHandler.Target> implements AssembleOperationHandler {
