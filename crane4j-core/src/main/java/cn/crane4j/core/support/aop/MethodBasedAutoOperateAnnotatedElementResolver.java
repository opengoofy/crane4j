...
public class MethodBasedAutoOperateAnnotatedElementResolver implements AutoOperateAnnotatedElementResolver {
    ...
    public AutoOperateAnnotatedElement resolve(@NonNull AnnotatedElement element, AutoOperate annotation) {
        ...
        if (!ClassUtils.isObjectOrVoid(annotationSpecifiedType)) {
            ...
            return AutoOperateAnnotatedMethod.forStaticTypeOperation(
        ...
        return AutoOperateAnnotatedMethod.forDynamicTypeOperation(
