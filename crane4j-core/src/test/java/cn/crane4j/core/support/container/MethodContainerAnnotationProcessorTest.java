...
/**
 * test for {@link MethodContainerAnnotationProcessor}
 *
 * @author huangchengxing
 */
public class MethodContainerAnnotationProcessorTest {
    ...
    public void init() {
        ...
        processor = new MethodContainerAnnotationProcessor(new SimpleAnnotationFinder(), factories);
    }
