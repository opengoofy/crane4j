...
/**
 * test for {@link MethodHandlePropertyOperator}
 *
 * @author huangchengxing
 */
public class MethodHandlePropertyOperatorTest {

    private final MethodHandlePropertyOperator operator = new MethodHandlePropertyOperator(new HutoolConverterManager());
