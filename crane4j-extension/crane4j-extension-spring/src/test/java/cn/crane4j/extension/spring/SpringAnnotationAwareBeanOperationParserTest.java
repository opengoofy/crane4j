...
/**
 * test for {@link SpringAssembleAnnotationResolver}
 *
 * @author huangchengxing
 */
@TestPropertySource(properties = "crane4j.container-name = testContainer")
@RunWith(SpringRunner.class)
@ContextConfiguration(classes = {Crane4jSpringTestConfiguration.class, SpringAnnotationAwareBeanOperationParserTest.TestConfig.class})
