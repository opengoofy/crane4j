...
/**
 * test for {@link StringKeyRedisCacheManager} with real redis
 *
 * @author huangchengxing
 */
@Ignore // TODO remove this annotation after resolved the container job problem of github action
public class StringKeyRedisCacheManagerTest {
    ...
    private StringKeyRedisCacheManager cacheManager;
    ...
    public void init() {
        ...
        cacheManager = new StringKeyRedisCacheManager(redisTemplate);
