...
/**
 * An {@link Assemble} annotation with {@link Assemble#containerProviderName} as "dynamicSourceContainerProvider" specified by default.
 *
 * @author huangchengxing
 */
@Assemble(containerProviderName = "dynamicSourceContainerProvider")
@Documented
@Target({ElementType.ANNOTATION_TYPE, ElementType.FIELD})
@Retention(RetentionPolicy.RUNTIME)
public @interface AssembleDynamicSource {
